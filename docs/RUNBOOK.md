...
DB 자동 백업, AES-256-GCM 암호화, 7 daily/4 weekly/3 monthly 보존, 26시간 실패 감지와 disposable restore 절차는 [P6-06 DB Backup runbook](P6_06_DB_BACKUP.md)을 따른다. backup failure 전달의 secret/중복 억제/recovery 계약은 [P6-03 backup alert receiver](P6_03_BACKUP_ALERTS.md)를 따른다.
