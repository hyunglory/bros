...
| P6-04 Production R2 ObjectStorage Adapter | IMPLEMENTED_NOT_VALIDATED | DEC-20260914-016, DEC-20260915-001, 실제 private Cloudflare R2에서 put/get·content-type/SHA-256 metadata·unsigned 거부·300초 signed preview·wrong-secret `STORAGE_AUTH_FAILED` PASS | public HTTPS/remote CI는 NOT_RUN |
| P6-05 Artifact Retention / Cleanup | IMPLEMENTED_NOT_VALIDATED | DEC-20260914-017, DEC-20260915-001, 실제 private R2와 PostgreSQL 18.6에서 held 1건 보존·unheld 2건 삭제·hold 해제 후 1건 삭제 및 R2 provider/bucket audit PASS | public staging/remote CI는 NOT_RUN; full integration suite 재실행 필요 |
