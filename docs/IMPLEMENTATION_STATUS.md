...
| P5-06 Demo Flow/Test Harness + P5-09/10 evidence | IMPLEMENTED_NOT_VALIDATED | DEC-20260914-014/015, DEC-20260915-002/009, actual Chromium evidence·disposable PostgreSQL/pg-boss success/failure·receipt 멱등성과 공개 HTTPS/R2 E2E·재시작, Actions run 34947247087 PASS | Admin Browser 실행 UI/HTTP enqueue는 이번 검증 범위 밖 |
| P6-01 인증 경계 + P5 durable DB/Queue 연결 | IMPLEMENTED_NOT_VALIDATED | DEC-20260914-014/015, DEC-20260915-002/009, public Quick Tunnel/Caddy auth·actor/token overwrite·Authorization 제거·same-origin gate·R2 preview·durable Worker/DB, Actions run 34947247087 PASS | native-domain Linux VM/host firewall 검증 잔여 |
| P6-04 Production R2 ObjectStorage Adapter | IMPLEMENTED_NOT_VALIDATED | DEC-20260914-016, DEC-20260915-001/002/009, 실제 private R2 및 public HTTPS authorized preview·SHA-256·unsigned 거부, Actions run 34947247087 PASS | production host hardening은 후속 |
| P6-02 Secret / Browser Profile 운영 Hardening | IMPLEMENTED_NOT_VALIDATED | DEC-20260915-005~007/009, Linux file secret·DB/proxy 교체·API/Worker/Caddy·metadata/log scan·UID negative·실제 profile 재사용/만료·backup exclusion·backup key/webhook provisioning 회귀, Actions run 34947247087 PASS | 실제 운영 host ACL/secret manager, R2·Provider/live alert receiver 검증 필요 |
| P6-05 Artifact Retention / Cleanup | PASS | DEC-20260914-017, DEC-20260915-001~004/009, start 포함 4종의 실제 private R2 hold/release·cleanup·audit·empty/private 확인, Local/PostgreSQL 회귀 및 Actions run 34947247087 PASS | 완료 |
| P6-03 Observability / 운영 Dashboard (backup alert receiver 부분) | IN_PROGRESS | DEC-20260915-007, private state 기반 failure 전달·동일 incident 재시도/중복 억제·recovery, disposable Docker 실제 HTTP receiver PASS | correlation/queue lag/worker heartbeat/provider metrics/Dashboard 및 live external receiver 검증 필요 |
| P6-06 DB Backup 자동화 / 암호화 / 복구 검증 | IMPLEMENTED_NOT_VALIDATED | DEC-20260915-006~009, 실제 private R2 encrypted pair/hash/plaintext 부재·15 generation retention pair delete·disposable restore RTO 1,318ms·wrong credential·exact cleanup·Actions run 34947247087 PASS | 운영 host 24h scheduler/live external alert receiver·대용량 DB RTO 검증 필요 |
| P6-10 Production Docker / Reverse Proxy / HTTPS | IMPLEMENTED_NOT_VALIDATED | DEC-20260915-002/006/009, 공개 Quick Tunnel TLS 1.3·DNS·Caddy auth·내부망 격리·R2 Browser run 및 재시작 E2E, Actions run 34947247087 PASS, P6_10_STAGING.md | custom-domain Linux VM/Caddy ACME·실제 host firewall, P6-06 live R2/scheduler 잔여; 일반 test runner 종료 문제 별도 |
