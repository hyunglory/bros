...
| P6-05 Artifact Retention / Cleanup | IMPLEMENTED_NOT_VALIDATED | DEC-20260914-017, DEC-20260915-001/002, 실제 R2 held/unheld cleanup·audit PASS, Linux 회귀 PASS | durable demo start.png가 운영 retention inventory에서 누락됨: 후속 보완 필요 |
