...
- 최초 원격 Phase 3 CI는 SHA `70e05bdb876acc0ebe7a0f2993ee6444d36baa8a`에서 통합 테스트 master process가 개별 파일 결과 없이 취소됐다. install/publication path/lint/typecheck/unit은 성공했고 format/build는 skip됐다. 통합 테스트를 파일별 별도 Node process로 순차 실행하도록 수정하고, 새 PostgreSQL에서 30 files/191 PASS로 재검증했다. 수정 SHA `7265dcddc425bba2e13e24f7276e7e352d973e31`의 workflow 35039591619/job 104616259592는 install부터 build까지 SUCCESS(4m10s)였다.
